...
let name = await conn.getName(who)
 ...
 const ini = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `⁨ekuzika123⁩̶᳡⁩@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://www.instagram.com/ekuzikaa_18`, `Citlaa♡`],
    [`${conn.user.jid.split('@')[0]}`, `${await conn.getName(conn.user.jid)}`, `🔥 Bot WhatsApp 🐣`, `📵 Don't spam/call me 😢`, `Nothing`, `🇮🇩 Indonesia`, `🚀 https://www.instagram.com/ekuzikaa_18`, `🤖 Dont Forget To Donate!`]
  ], fkontak)
